  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex flex-col">
      ...
      <div className="relative container mx-auto px-4 py-12 flex-grow">
        <h1 className="text-5xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 mb-4 animate-fade-in-up">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-sm text-gray-600 text-center md:text-right">
              © 2024 Plateforme de Suivi des Projets Académiques. Tous droits réservés.
            </div>
          </div>
        </div>
      </footer>
